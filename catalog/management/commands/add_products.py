...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for product_data in products:
            ...
            if created:
                self.stdout.write(self.style.SUCCESS(f'Product added successfully: {product.name}'))
            else:
                self.stdout.write(self.style.SUCCESS(f'Product already exists: {product.name}'))