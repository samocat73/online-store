    ...
    def handle(self, *args, **options):
        ...
        products = [
            ...
            },
            {
                ...
                "description": (
                    "Утюг Polaris PIR 2420AK в стильном исполнении способен"
                    "сделать процесс глажки достаточно удобным и быстрым."
                ),
                "category": irons,
                "price": 3199,
            },
            {
                ...
                "description": (
                    "Утюг Braun TexStyle 9 SI9661VI с мощностью 3100 Вт, непрерывной"
                    "подачей пара 0-60 г/мин и паровым ударом до 250 г/мин устраняет стойкие складки."
                ),
                "category": irons,
                "price": 9699,
            },
